...
## xilinx.com:ip:proc_sys_reset:5.0
  ## connect axi
#   connect_bd_intf_net -intf_net M_AXI_GP0_1 [get_bd_intf_pins axi_counter_0/s00_axi] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
